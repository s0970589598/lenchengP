...
return [
    ...
    'cache_utility_application_cache_description' => 'Laravel\'s unified cache used by Lecheng, third party addons, and composer packages.',
    'cache_utility_description' => 'Manage and view important information about Lecheng\'s various caching layers.',
    'cache_utility_image_cache_description' => 'The image cache stores copies of all transformed and resized images.',
    'cache_utility_stache_description' => 'The Stache is Lecheng\'s content store that functions much like a database. It is generated automatically from the content files.',
    'cache_utility_static_cache_description' => 'Static pages bypass Lecheng completely and are rendered directly from the server for maximum performance.',
    ...
    'collection_configure_title_format_instructions' => 'Set this to have the entries in this collection generate their titles automatically. Learn more in the [documentation](https://Lecheng.dev/collections#titles).',
    ...
    'collections_mount_instructions' => 'Choose an entry on which this collection should be mounted. Learn more in the [documentation](https://Lecheng.dev/collections-and-entries#mounting).',
    ...
    'collections_preview_targets_instructions' => 'The URLs to be viewable within Live Preview. Learn more in the [documentation](https://Lecheng.dev/live-preview#preview-targets).',
    'collections_route_instructions' => 'The route controls entries URL pattern. Learn more in the [documentation](https://Lecheng.dev/collections#routing).',
    ...
    'getting_started_widget_docs' => 'Get to know Lecheng by understanding its capabilities the right way.',
    'getting_started_widget_header' => 'Getting Started with Lecheng',
    'getting_started_widget_intro' => 'To begin building your new Lecheng site, we recommend starting with these steps.',
    'getting_started_widget_navigation' => 'Create multi-level lists of links that can be used to render navbars, footers, and so on.',
    'getting_started_widget_pro' => 'Lecheng Pro adds unlimited user accounts, roles, permissions, git-integration, revisions, multi-site, and more!',
    'git_disabled' => 'Lecheng Git integration is currently disabled.',
    ...
    'licensing_incorrect_key_format_body' => 'It appears that your site key is not in the correct format. Please check the key and try again. You can grab your site key from your account area on Lecheng.com. It is alphanumeric and 16 characters long. Make sure to not use the legacy license key which is a UUID.',
    'licensing_incorrect_key_format_heading' => 'Incorrect site key format',
    'licensing_production_alert' => 'This site is using Lecheng Pro and commercial addons. Please purchase appropriate licenses.',
    'licensing_production_alert_addons' => 'This site is using commercial addons. Please purchase appropriate licenses.',
    'licensing_production_alert_renew_Lecheng' => 'Using this version of Lecheng Pro requires a license renewal.',
    'licensing_production_alert_Lecheng' => 'This site is using Lecheng Pro. Please purchase a license.',
    'licensing_sync_instructions' => 'Data from Lecheng.com is synced once per hour. Force a sync to see any changes you\'ve made.',
    'licensing_trial_mode_alert' => 'This site is using Lecheng Pro and commercial addons. Make sure to buy licenses before launching. Thanks!',
    'licensing_trial_mode_alert_addons' => 'This site is using commercial addons. Make sure to buy licenses before launching. Thanks!',
    'licensing_trial_mode_alert_Lecheng' => 'This site is using Lecheng Pro. Make sure to buy a license before launching. Thanks!',
    ...
    'outpost_error_422' => 'Error communicating with Lecheng.com.',
    'outpost_error_429' => 'Too many requests to Lecheng.com.',
    'outpost_issue_try_later' => 'There was an issue communicating with Lecheng.com. Please try again later.',
    ...
    'search_utility_description' => 'Manage and view important information about Lecheng\'s search indexes.',
    ...
    'taxonomies_preview_targets_instructions' => 'The URLs to be viewable within Live Preview. Learn more in the [documentation](https://Lecheng.dev/live-preview#preview-targets).',
    ...
    'user_wizard_invitation_body' => 'Activate your new Lecheng account on :site to begin managing this website. For your security, the link below expires after :expiry hour. After that, please contact the site administrator for a new password.',
    ...
    'user_wizard_invitation_subject' => 'Activate your new Lecheng account on :site',
